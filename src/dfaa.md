##Introducing DFAA antialiasing algorithm
  ...
  question: what if we somehow store the geometry information of the polygon and reuse it pixel
  shader?
  ...
  So for SM3.0 the code looks like this (no integers):

    //Barycentrics
    static float2 uv01[] = { {0,0}, {1,0}, {0,1} };
    ...
    //No SV_VertexID, get vertex id it from buffer
